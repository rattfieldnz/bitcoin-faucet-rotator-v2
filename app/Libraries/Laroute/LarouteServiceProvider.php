...
namespace App\Libraries\Laroute;

use Illuminate\Support\ServiceProvider;
use App\Libraries\Laroute\Console\Commands\LarouteGeneratorCommand;
...
class LarouteServiceProvider extends ServiceProvider
{
    ...
    {
        return config_path('laroute.php');
    }
    ...
    {
        $this->app->bind(
            'App\Libraries\Laroute\Generators\GeneratorInterface',
            'App\Libraries\Laroute\Generators\TemplateGenerator'
        );
    }
    ...
    {
        $this->app->bind(
            'App\Libraries\Laroute\Compilers\CompilerInterface',
            'App\Libraries\Laroute\Compilers\TemplateCompiler'
        );
    }
    ...
    protected function registerCommand()
    {
        $this->app->singleton(
            ...
            function ($app) {
                ...
                $generator  = $app->make('App\Libraries\Laroute\Generators\GeneratorInterface');
