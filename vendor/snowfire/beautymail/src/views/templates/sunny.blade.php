<html>
<head>
    <title>{{ env('APP_NAME') . ' admin' or '' }}</title>
            ...
            <table class="w640" border="0" cellpadding="0" cellspacing="0" width="640">
                ...
                <tr class="mobile_only">
                    <td class="w640" width="640" align="center">
                        <img class="mobile_only mobile-logo" border="0" src="{{ $logo['path'] }}" alt="{{ env('APP_NAME') . ' admin' or '' }}" width="{{ $logo['width'] }}" height="{{ $logo['height'] }}" />
                    </td>
                </tr>
                <tr class="mobile_only">
                    <td class="w640" height="20" width="640"></td>
                        ...
                        <table class="w640" border="0" cellpadding="0" cellspacing="0" width="640">
                            <tr>
                                ...
                                <td id="logo" width="{{ $logo['width'] }}" valign="top">
                                    <img border="0" src="{{ $logo['path'] }}" alt="{{ env('APP_NAME') . ' admin' or ''}}" width="{{ $logo['width'] }}" height="{{ $logo['height'] }}" />
                                </td>
                                <td class="w30" width="30"></td>
                            </tr>
                            <tr>
