...
<html>
    ...
    <body>
        <div class="extra-info">
            <h1 style="font-size:1.25em;font-weight:700;">A bug has occurred!</h1>
            <p>Please forward this to your developer {{ !empty(env('DEVELOPER_EMAIL')) ? '(' . env('DEVELOPER_EMAIL') . ')' : '' }}.</p>
        </div>
        {!! $content !!}
        <div class="extra-info">
