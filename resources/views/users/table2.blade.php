...
<div class="chart">
    <table id="usersTable" class="row-border hover order-column table-hover table-responsive" cellspacing="0" width="100%">
        <thead>
...
<script src="/assets/js/user-scripts/usersDatatables.js?{{ rand() }}"></script>
<script>
    $(function () {
