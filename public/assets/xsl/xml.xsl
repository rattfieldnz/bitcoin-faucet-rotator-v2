        ...
        <html lang="en">
            ...
            <body class="skin-blue sidebar-mini" id="guest-bg">
                <div id="main-wrapper">
                                                            ...
                                                            <div class="row">
                                                                <div id="ads row">
                                                                    <p style="text-align:center;">
                                                                        <iframe scrolling="no"
                                                                                src="//mellowads.com/view/BB9EA85CA2BD"
                                                                                style="width:234px;height:60px;border:none;"/>
                                                                        <iframe scrolling="no"
                                                                                src="//mellowads.com/view/865C6139C3E5"
                                                                                style="width:234px;height:60px;border:none;"/>
                                                                        <iframe scrolling="no"
                                                                                src="//mellowads.com/view/CA3246A894E8"
                                                                                style="width:234px;height:60px;border:none;"/>
                                                                        <iframe scrolling="no"
                                                                                src="//mellowads.com/view/DF40C884F854"
                                                                                style="width:234px;height:60px;border:none;"/>
                                                                    </p>
                                                                </div>
                                                                <div class="col-lg-12">
                    ...
                    <!-- START Main Footer -->
                    <footer id="footer-custom" class="main-footer footer-custom-guest row">
